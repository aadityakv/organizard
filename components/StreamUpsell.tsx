...
export function StreamUpsell({ visible, onClose, onTryPro }: { visible: boolean; onClose: () => void; onTryPro: () => void }) {
  return (
    <Sheet visible={visible} onClose={onClose}>
      <View style={styles.head}>
        ...
        <Text style={styles.sub}>Snap or speak item after item — Tuck fills in the name, count and value as you go. Part of Tuck Pro.</Text>
      </View>
      ...
      <Button fullWidth size="lg" onPress={onTryPro}>Try Pro free for 7 days</Button>
      <Button variant="ghost" fullWidth onPress={onClose} style={{ marginTop: 4 }}>Maybe later</Button>
    </Sheet>
  );
}
...
const styles = StyleSheet.create({
  ...
  tile: { width: 56, height: 56, borderRadius: 16, backgroundColor: palette.green50, alignItems: 'center', justifyContent: 'center', marginBottom: 14 },
  title: { fontFamily: fonts.display.bold, fontSize: 23, color: palette.ink900, textAlign: 'center' },
  sub: { fontSize: 14, fontFamily: fonts.body.bold, color: palette.ink500, textAlign: 'center', lineHeight: 22, marginTop: 8, maxWidth: 300 },
