...
import { fonts, alpha, palette } from '@/theme';
...
const styles = StyleSheet.create({
  ...
  corner: { position: 'absolute', width: 28, height: 28, borderColor: alpha(palette.white, 0.85) },
  ...
  hint: { color: alpha(palette.white, 0.7), fontFamily: fonts.body.bold, fontSize: 13, textAlign: 'center' },
  simNote: {
    color: alpha(palette.white, 0.45),
